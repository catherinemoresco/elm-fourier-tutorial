...
Elm.FourierSeries.make = function (_elm) {
   ...
   var equationImg = function (n) {
      ...
      $List.concat(_U.list([_U.list([fx])
                           ...
                           ,A2($List.intersperse,plus,A2($List.map,equationTermImg,_U.range(1,n - 1)))
                           ,_U.list([plus])
                           ,_U.list([lastTermImg(n)])
                           ,_U.list([closeParen])])));
   };
   ...
   var unsafeToInt = function (x) {
      ...
      if (_p0.ctor === "Ok") {
            ...
            return _U.crashCase("FourierSeries",{start: {line: 72,column: 17},end: {line: 74,column: 58}},_p0)("unsafeToInt called on a bad string");
         }
   };
   ...
   var view = function (v) {
      ...
      _U.list([A2($Graphing.graph,
              $List.concat(_U.list([A3($List.map2,
                                   ...
                                   ,_U.list([{ctor: "_Tuple2",_0: squareWave,_1: $Graphing.defaultPlot}
                                            ,{ctor: "_Tuple2",_0: A2(sineWavesAtN,1,x),_1: _U.update($Graphing.defaultPlot,{strokeColor: "#D2527F"})}])])),
              graphStyle(0))
